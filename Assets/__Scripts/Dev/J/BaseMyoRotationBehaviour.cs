...
public class BaseMyoRotationBehaviour : MonoBehaviour
{
    ...
    //public GameObject _thalmicMyo = null;
    ...
    private void Update()
    {
        ...
        // * Catch switch statement poses - perform relevant actions
        if (dTapReference)
        {
            ...
            Vector3 referenceZeroRoll = computeZeroRollVector(_thalmicMyo.transform.forward);
            _referenceRoll = rollFromZero(referenceZeroRoll, _thalmicMyo.transform.forward, _thalmicMyo.transform.up);
        }



        // Current zero roll vector and roll value.
        Vector3 zeroRoll = computeZeroRollVector(_thalmicMyo.transform.forward);
        float roll = rollFromZero(zeroRoll, _thalmicMyo.transform.forward, _thalmicMyo.transform.up);
    ...
    void FixedUpdate()
    {
        ...
        //rb.transform.position += transform.forward * Time.deltaTime * velocity;
    ...
    Vector3 computeZeroRollVector(Vector3 forward)
    {
        ...
        Vector3 m = Vector3.Cross(_thalmicMyo.transform.forward, antigravity);
        Vector3 roll = Vector3.Cross(m, _thalmicMyo.transform.forward);
    ...
    // recognized.
    void ExtendUnlockAndNotifyUserAction(ThalmicMyo _thalmicMyo)
    {
